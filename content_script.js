...
$(function () {
    ...
    $("#edit_body").append("<div id='uploadOutPic' style='line-height:30px'><img src='" + syncPicUrl + "' title='点击同步外部图片' align='left' width='30' height='30'/><span>点击同步外部图片</span></div>");
...
function GetMarkDownPic(md) {
    ...
    {
        $("#uploadOutPic span").text("未找到符合条件的图片URL");
    }
}
